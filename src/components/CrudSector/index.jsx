...
export const CrudSector = () => {
  const {
    state, getSector, AddSector, DeleteSector, UpdateSector
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await getSector(pagination, globalFilter, columnFilters, sorting)
  ...
  return (
    <ContainerBox>
      <TitleModule>Sector</TitleModule>
      {modalEliminar &&
        <Modal closeModal={setModalEliminar}>
          <Delete data={dataEliminar} closeModal={setModalEliminar} preData={preData} setReload={setReload} DeleteSector={DeleteSector} modedark={state.darkMode} />
        </Modal>}

      {modalUpdate &&
        <Modal closeModal={setModalUpdate}>
          <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateSector={UpdateSector} modedark={state.darkMode} />
        </Modal>}
      {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

      {modal &&
        <Modal closeModal={setModal}>
          <Register setModal={setModal} setReload={setReload} preData={preData} AddSector={AddSector} modedark={state.darkMode} />
        </Modal>}
