...
export const CrudSatelital =
 () => {
   ...
   useEffect(() => {
     const fetchData = async () => {
       try {
         ...
         const response = await getSatelitales(pagination, globalFilter, columnFilters, sorting)
   ...
   return (
     <ContainerBox>
       <TitleModule>Satelital</TitleModule>
       {modalEliminar &&

         <Modal closeModal={setModalEliminar}>
           <Delete data={dataEliminar} closeModal={setModalEliminar} preData={preData} setReload={setReload} DeleteSatelital={DeleteSatelital} modedark={state.darkMode} />
         </Modal>}

       {modalUpdate &&
         <Modal closeModal={setModalUpdate}>
           <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateSatelitales={UpdateSatelitales} modedark={state.darkMode} />
         </Modal>}
       {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

       {modal &&
         <Modal closeModal={setModal}>
           <Register setModal={setModal} setReload={setReload} preData={preData} AddSatelitales={AddSatelitales} modedark={state.darkMode} />
         </Modal>}
