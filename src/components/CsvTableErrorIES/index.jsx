...
export const MatrizIESError = ({ data, setModalCsv, setReload, MatrizCargada, onCloseFile }) => {
  ...
  const handleSaveCell = (cell, value) => {
    ...
    } else if (cell.column.id === 'valorSemestre' || cell.column.id === 'recargo' || cell.column.id === 'descuentos') {
