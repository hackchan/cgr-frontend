...
export const CrudContratoEstado = () => {
  const {
    state,
    GetEstadoContrato,
    AddEstadoContrato,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await GetEstadoContrato(pagination, globalFilter, columnFilters, sorting)
  ...
  return (
    <ContainerBox>
      <TitleModule>Estado Contrato</TitleModule>
      {modalEliminar &&
        <Modal closeModal={setModalEliminar}>
          <Delete data={dataEliminar} closeModal={setModalEliminar} preData={preData} setReload={setReload} DeleteEstadoContrato={DeleteEstadoContrato} modedark={state.darkMode} />
        </Modal>}

      {modalUpdate &&
        <Modal closeModal={setModalUpdate}>
          <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateEstadoContrato={UpdateEstadoContrato} modedark={state.darkMode} />
        </Modal>}
      {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

      {modal &&
        <Modal closeModal={setModal}>
          <Register setModal={setModal} setReload={setReload} preData={preData} AddEstadoContrato={AddEstadoContrato} modedark={state.darkMode} />
        </Modal>}
