...
export const CrudOrigenRecurso = () => {
  const {
    state,
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await GetOrigenRecursoObra(pagination, globalFilter, columnFilters, sorting)
  ...
  return (
    <ContainerBox>
      <TitleModule>Origen Recursos</TitleModule>
      {modalEliminar &&
        <Modal closeModal={setModalEliminar}>
          <Delete data={dataEliminar} closeModal={setModalEliminar} preData={preData} setReload={setReload} DeleteOrigenRecursoObra={DeleteOrigenRecursoObra} modedark={state.darkMode} />
        </Modal>}

      {modalUpdate &&
        <Modal closeModal={setModalUpdate}>
          <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateOrigenRecursoObra={UpdateOrigenRecursoObra} modedark={state.darkMode} />
        </Modal>}
      {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

      {modal &&
        <Modal closeModal={setModal}>
          <Register setModal={setModal} setReload={setReload} preData={preData} AddOrigenRecursoObra={AddOrigenRecursoObra} modedark={state.darkMode} />
        </Modal>}
