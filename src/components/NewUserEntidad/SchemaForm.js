...
export const formSchema = Yup.object().shape({
  ...
  username: Yup.string()
    ...
    .matches(
      ...
      'Username no valido, el primer caracter debe ser una letra, sin espacios ni caracteres especiales'
    ),
  name: Yup.string()
  ...
  password: Yup.string()
    ...
    .matches(
      /^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$/,
      'La contraseña: Longitud entre 8 y 16 caracteres, al menos un dígito, al menos una minúscula, al menos una mayúscula y al menos un caracter no alfanumérico.'
    ),
