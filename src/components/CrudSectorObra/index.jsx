  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await GetSectorObra(pagination, globalFilter, columnFilters, sorting)
    ...
    <ContainerBox>
      ...
      {modalUpdate &&
        <Modal closeModal={setModalUpdate}>
          <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateSectorObra={UpdateSectorObra} modedark={state.darkMode} />
        </Modal>}
      {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

      {modal &&
        <Modal closeModal={setModal}>
          <Register setModal={setModal} setReload={setReload} preData={preData} AddSectorObra={AddSectorObra} modedark={state.darkMode} />
        </Modal>}
