...
export const CrudEstadoObra = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await GetEstadoObra(pagination, globalFilter, columnFilters, sorting)
  ...
  return (
    <ContainerBox>
      <TitleModule>Estado Obra</TitleModule>
      {modalEliminar &&
        <Modal closeModal={setModalEliminar}>
          <Delete data={dataEliminar} closeModal={setModalEliminar} preData={preData} setReload={setReload} DeleteEstadoObra={DeleteEstadoObra} modedark={state.darkMode} />
        </Modal>}

      {modalUpdate &&
        <Modal closeModal={setModalUpdate}>
          <Update setModal={setModalUpdate} setReload={setReload} preData={preData} data={dataUpdate} UpdateEstadoObra={UpdateEstadoObra} modedark={state.darkMode} />
        </Modal>}
      {/* <ButtonAdd onClick={() => { setModal(true) }}>Nuevo {preData.title}</ButtonAdd> */}

      {modal &&
        <Modal closeModal={setModal}>
          <Register setModal={setModal} setReload={setReload} preData={preData} AddEstadoObra={AddEstadoObra} modedark={state.darkMode} />
        </Modal>}
